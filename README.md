...
این نمودار نشان می‌دهد که رشت در تمامی سال‌ها و فصل‌ها، به‌ویژه در پاییز و زمستان، بیشترین میزان بارش را داشته است؛ در حالی که قم کم‌باران‌ترین شهر بوده و تنها در فصول سرد بارش قابل‌توجهی داشته است. تهران نیز نوسانات بارشی داشته و در برخی سال‌ها مانند ۲۰۲۴ زمستان پربارش‌تری را تجربه کرده است.
